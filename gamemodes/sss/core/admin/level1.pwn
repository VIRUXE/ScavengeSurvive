...
ACMD:mute[1](playerid, params[])
{
	...
	if(sscanf(params, "dds[128]", targetid, duration, reason))
	...
	if(duration > 0)
	{
		...
		ChatMsg(playerid, YELLOW, " >  Muted player %P "C_WHITE"for %d seconds.", targetid, duration);
		ChatMsgLang(targetid, YELLOW, "MUTEDANTIME", duration, reason);
	}
	else
	{
